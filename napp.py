...
from pages.delivery import delivery_menu
...
menus = [index_menu, delivery_menu]
menu_links = {}
...
def generate_sidebar():
    ...
    # it consists of a title, and a toggle, t
    # he latter is hidden on large screens
    sidebar_header = dbc.Row(
        [
            dbc.Col(html.A([html.H2([html.Img(src='/assets/covidata.png', style={"height": "70px", "margin-right": "5px"}), "Covidata.be"], id="sidebar-title", className="display-6")], href="/", style={"color":"black","text-decoration": "none"})),
            dbc.Col(
                [
                    html.Button(
