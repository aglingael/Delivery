...
source_delivery = SourceProvider("B-Post", "delivery.be",
                                  lazy_gettext("Data Provided by delivery in the context of the data-science chair between UCLouvain and delivery"))
